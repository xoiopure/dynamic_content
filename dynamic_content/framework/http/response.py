"""Response related implementations"""
...
HttpResponseCodes = (collections.namedtuple('ResponseCodeContainer', (
...
class Response(object):
    """
    Value object modelling a http response
    """
    __slots__ = 'body', 'code', 'headers', 'cookies'
...
class Redirect(Response):
    """
    Value object modelling a response with a redirect
    """
    __slots__ = ()
